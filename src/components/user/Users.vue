<template>
  <div>
    ...
    <el-dialog title="分配角色" :visible.sync="setRoleDislogVisible" width="30%">
      <div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="setRoleDislogVisible = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async setRole (userInfo) {
      ...
      // 在展示对话框之前获取所有的角色列表
      const { data: res } = await this.$hhtp.get('roles')
